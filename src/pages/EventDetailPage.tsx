    ...
    <div className="min-h-screen pt-20 pb-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          {/* AI Prediction Card */}
          <div className="data-card border-ocean-seafoam/30">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold flex items-center gap-2">
                <Brain className="w-5 h-5 text-ocean-seafoam" />
                AI Kalshi Pulse
              </h2>
              <button
                onClick={handleGeneratePrediction}
                disabled={generatingPrediction}
                className="flex items-center gap-2 px-3 py-1.5 bg-ocean-seafoam/10 text-ocean-seafoam rounded-lg text-sm hover:bg-ocean-seafoam/20 transition-colors disabled:opacity-50"
              >
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-background-tertiary rounded-lg p-4">
                    ...
                    <div className="text-3xl font-bold text-ocean-seafoam">
